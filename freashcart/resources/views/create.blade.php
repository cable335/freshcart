      ...
      <div class="offcanvas-header">
        <h5 class="offcanvas-title" id="offcanvasExampleLabel">
          <a href="https://freshcart.codescandy.com/dashboard/order-list.html"><img
              src="https://freshcart.codescandy.com/assets/images/logo/freshcart-logo.svg" alt=""></a>
        </h5>
      </div>
        ...
        <div class="row col-12">
          ...
          <div class="collapse" id="collapseExample">
            <div class="box-no-border">
              <ul>
                <li><button class="menuBtn box-no-border d-flex justify-content-start align-items-center">List</button>
                </li>
                <li><button
                    class="menuBtn box-no-border d-flex justify-content-start align-items-center">Single</button></li>
              </ul>
            </div>
          </div>
          <!-- 內標題Orders結束 -->
          ...
          <div class="menutext2"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
    ...
    <div class="Nav p-3">
      <div class="navbar d-flex justify-content-between align-items-center w-100">
        ...
        <div class="menu-offcanvas offcanvas offcanvas-start p-3 " tabindex="-1" id="offcanvasExample"
          ...
          <div class="offcanvas-body">
            <div class="row col-12">
              ...
              <!-- 內標題Orders -->
              <p class="d-inline-flex gap-1">
                <button class="menuBtn box-no-border d-flex justify-content-start align-items-center" type="button"
              ...
              <div class="collapse" id="collapseExample">
                <div class="box-no-border">
                  <ul>
                    <li><button
                        class="menuBtn box-no-border d-flex justify-content-start align-items-center">List</button></li>
                    <li><button
        ...
        <div class="bell-and-user d-flex flex-shrink-0">
          <!-- 小鈴鐺 -->
          <div class="btn-group">
            <button type="button" class="bell box-no-border  position-relative" data-bs-toggle="dropdown"
              data-bs-display="static" aria-expanded="false">
              <img src="./img/bell.svg" />
              <div class="position-absolute top-0 start-90 translate-middle badge rounded-pill bg-danger mt-2 ms-n2">2
              </div>
            </button>
            <div class="bell dropdown-menu dropdown-menu-end bellpos">
              <div class="bellNav p-3 d-flex justify-content-between">
                ...
                <button class="circleMark box-no-border btn btn-light"><svg xmlns="http://www.w3.org/2000/svg"
                ...
                <ul class="m-0 p-0">
                  <a href="#" class="textnodecoration">
                    <li class="list-group-item list-group-item-action active p-3 d-flex justify-content-between"
                      ...
                      <div><img src="./img/avatar-1.jpg" alt="" class="circleMark m"></div>
                      <div><span class="text-dark belltext">Your order is placed&nbsp;&nbsp;<span class="text">waiting
                            for shipping</span></span>
                        <div class="belltextsm"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                  ...
                  <a href="#" class="textnodecoration">
                    <li class="list-group-item list-group-item-action active p-3 d-flex justify-content-between">
                      <div><img src="./img/avatar-5.jpg" alt="" class="circleMark m"></div>
                      <div><span class="text-dark belltext">Jitu Chauhan &nbsp;<span class="text"> answered to your
                  ...
                  <a href="#" class="textnodecoration">
                    <li class="list-group-item list-group-item-action active p-3 d-flex justify-content-between">
                      <div><img src="./img/avatar-2.jpg" alt="" class="circleMark m"></div>
                      <div><span class="text-dark belltext">You have new messages &nbsp;<span class="text"> 2 unread
                            messages
                          </span></span>
                        <div class="belltextsm"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                            fill="currentColor" class="bi bi-clock" viewBox="0 0 16 16">
          ...
          <!-- 人物 -->
          <div class="btn-group">
            <button type="button" class="box-no-border" data-bs-toggle="dropdown" aria-expanded="false">
