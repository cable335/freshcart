        ...
        <div class="col-12 my-5">
            <div class="container">
                ...
                <div class="swiper mySwiper-1">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide border"><a href=""><img src="./img/S__120037379.gif" alt=""><span
                                    class="color-cjo">ccc</span></a></div>
                        <div class="swiper-slide border"><a href=""><img src="./img/S__120037379.gif" alt=""><span
                                    class="color-cjo">ccc</span></a></div>
                        <div class="swiper-slide border"><a href=""><img src="./img/S__120037379.gif" alt=""><span
                                    class="color-cjo">ccc</span></a></div>
                    ...
                    <div class="col">
                        <div class="card-body p-3 border-r-10 border">
                            <div class="card-img">
                                ...
                                <h2><a class="d-flex justify-contnent-start fs-6 color-black" href="">{{ $product->name }}</a></h2>
                                <div class="row">
                            ...
                            <div class="card-img">
                                ...
                                <div class="row justify-content-center">
                                    ...
                                    <div class="row gap-1 d-flex justify-content-center mt-2">
                                        <div
                                            class="col-3 border h-100 w-62-h-57-color-cjo d-grid justify-content-center">
                                            <div id="days"
                ...
                <div class="row ">
                    <div class="col">
                        <div class="card-body p-3 ">
                            ...
                            <div class="card-text mb-2">
                                <h5 class="d-flex justify-content-start color-black" href="">10 minute grocery now</h5>
                            </div>
                    ...
                    <div class="col">
                        <div class="card-body p-3 ">
                            ...
                            <div class="card-text mb-2">
                                <h5 class="d-flex justify-content-start color-black" href="">Best Prices & Offers</h5>
                            </div>
                            <h2><span class="d-flex justify-contnent-start fs-6 color-cjo" href="">Cheaper prices than
